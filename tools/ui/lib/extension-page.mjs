...
export async function openExtensionPage(
  browser,
  base,
  { pagePath = POPUP, theme = 'light', width = 460, height = 1000, deviceScaleFactor = 1, stub = {}, settle = 700, routes = [] } = {}
) {
...
export function brandImagesLoaded(page) {
  return page.evaluate(() => [...document.images].filter(i => i.src.includes('/brand/')).every(i => i.complete && i.naturalWidth > 0));
}
